...
const mockVendors: Vendor[] = [
  ...
  },
  {
    ...
    company_name: "Karthik Enterprises",
    city: "Chennai",
    state: "Tamil Nadu",
    country: "India",
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    company_name: "Singh Distributors",
    city: "Hyderabad",
    state: "Telangana",
    country: "India",
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    company_name: "Nair Distributors",
    city: "Kochi",
    state: "Kerala",
    country: "India",
    createdAt: new Date().toISOString(),
